...
public class GiangVien extends Nguoi {
    ...
    public GiangVien(String maGiangVien, String hoTen, Date ngaySinh, boolean gioiTinh, String sdt, String email, String diaChi, 
                     String trinhDo, String bangCap, int kinhNghiem) {
